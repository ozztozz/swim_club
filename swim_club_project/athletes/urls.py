...
from athletes.views_dashboard import parent_dashboard, dashboard_index, other_menu, approve_athlete_htmx, edit_athlete_team_htmx, reject_athlete_htmx, search_approved_athletes_htmx, dashboard_recent_payments_htmx
...
urlpatterns = [
    ...
    path('other/', other_menu, name='other-menu'),
