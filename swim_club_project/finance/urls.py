...
urlpatterns = [
    ...
    path('equipment/<int:pk>/toggle-active/', views.equipment_toggle_active, name='equipment-toggle-active'),
    path('equipment/stock/', views.equipment_stock, name='equipment-stock'),
    path('equipment/stock/modal/', views.equipment_stock_modal, name='equipment-stock-modal'),
